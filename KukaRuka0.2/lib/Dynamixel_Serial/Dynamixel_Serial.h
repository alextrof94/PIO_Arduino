...
/* IR AREA */
// IR EEPROM
#define EEPROM_IR_TRESHOLD1_L           0x06
#define EEPROM_IR_TRESHOLD1_H           0x07
#define EEPROM_IR_TRESHOLD2_L           0x08
#define EEPROM_IR_TRESHOLD2_H           0x09
#define EEPROM_IR_TRESHOLD3_L           0x0A
#define EEPROM_IR_TRESHOLD3_H           0x0B
#define EEPROM_IR_TRESHOLD4_L           0x0C
#define EEPROM_IR_TRESHOLD4_H           0x0D
#define EEPROM_IR_TRESHOLD5_L           0x0E
#define EEPROM_IR_TRESHOLD5_H           0x0F
#define EEPROM_IR_TRESHOLD6_L           0x11
#define EEPROM_IR_TRESHOLD6_H           0x12
#define EEPROM_IR_TRESHOLD7_L           0x13
#define EEPROM_IR_TRESHOLD7_H           0x14
// IR RAM
#define RAM_IR_FIREDATA1_L              0X18
#define RAM_IR_FIREDATA1_H              0X19
#define RAM_IR_FIREDATA2_L              0X1A
#define RAM_IR_FIREDATA2_H              0X1B
#define RAM_IR_FIREDATA3_L              0X1C
#define RAM_IR_FIREDATA3_H              0X1D
#define RAM_IR_FIREDATA4_L              0X1E
#define RAM_IR_FIREDATA4_H              0X1F
#define RAM_IR_FIREDATA5_L              0X20
#define RAM_IR_FIREDATA5_H              0X21
#define RAM_IR_FIREDATA6_L              0X22
#define RAM_IR_FIREDATA6_H              0X23
#define RAM_IR_FIREDATA7_L              0X24
#define RAM_IR_FIREDATA7_H              0X25
#define RAM_IR_BUZZER_NOTE              0X28
#define RAM_IR_BUZZER_TIME              0X29
#define RAM_IR_AUTO_TRESHOLD            0X2A
#define RAM_IR_OBJECT_DETECTED          0X2B
#define RAM_IR_TRESHOLD1_L              0X30
#define RAM_IR_TRESHOLD1_H              0X31
#define RAM_IR_TRESHOLD2_L              0X32
#define RAM_IR_TRESHOLD2_H              0X33
#define RAM_IR_TRESHOLD3_L              0X34
#define RAM_IR_TRESHOLD3_H              0X35
#define RAM_IR_TRESHOLD4_L              0X36
#define RAM_IR_TRESHOLD4_H              0X37
#define RAM_IR_TRESHOLD5_L              0X38
#define RAM_IR_TRESHOLD5_H              0X39
#define RAM_IR_TRESHOLD6_L              0X3A
#define RAM_IR_TRESHOLD6_H              0X3B
#define RAM_IR_TRESHOLD7_L              0X3C
#define RAM_IR_TRESHOLD7_H              0X3D
...
// IR
#define READ_FIREDATA_LENGTH            0x04
#define READ_DETECTED_LENGTH            0x04
#define SET_TRESHOLD_LENGTH             0x05
...
public:
    ...
    unsigned int readIRDetected(unsigned char);
    unsigned int readIRFiredata(unsigned char, unsigned char);
    unsigned int setRAMIRTreshold(unsigned char, unsigned char, int);
    unsigned int setEEPROMIRTreshold(unsigned char, unsigned char, int);
